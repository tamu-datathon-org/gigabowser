...
(function(factory) {
  ...
  Slick.prototype.setCSS = function(position) {
    ...
    x = _.positionProp == "left" ?
      Math.ceil(position) + "px" :
      "0px";
    y = _.positionProp == "top" ?
      Math.ceil(position) + "px" :
      "0px";
  ...
  Slick.prototype.setProps = function() {
    ...
    _.positionProp = _.options.vertical === true ?
      "top" :
      "left";
  ...
  Slick.prototype.setSlideClasses = function(index) {
    ...
    if (_.options.centerMode === true) {
      var evenCoef = _.options.slidesToShow % 2 === 0 ?
        1 :
        0;
  ...
  Slick.prototype.slideHandler = function(index, sync, dontAnimate) {
    ...
    _.currentLeft = _.swipeLeft === null ?
      slideLeft :
      _.swipeLeft;
