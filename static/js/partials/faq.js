...
$(function() {
  $(".faq-list").find(".accordion-toggle").click(function() {
    $(this).next().toggleClass("open").slideToggle("fast");
    $(this).toggleClass("active-tab").find(".scrabble").toggleClass("active");
    $(".faq-list .accordion-content").not($(this).next()).slideUp("fast").removeClass("open");
    $(".faq-list .accordion-toggle").not(jQuery(this)).removeClass("active-tab").find(".scrabble").removeClass("active");
  });
});