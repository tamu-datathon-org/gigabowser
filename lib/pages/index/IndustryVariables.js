const IndustryVariables = {
  industryModalVariables: [{
    ...
    industryPastSponsors: ['/static/img/sponsors/past/facebook.png', '/static/img/sponsors/past/walmart.png', '/static/img/sponsors/past/digitalocean.png', '/static/img/sponsors/past/github.png']
  }, {
    industryName: 'Energy',
    industryId: 'industry-energy',
    industryDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus id est nec molestie. Phasellus sit amet finibus enim. Sed aliquet mauris a velit ultricies, et ultricies velit malesuada.',
    industryImgPath: './static/img/icons/energy.svg',
    industryPastSponsors: ['/static/img/sponsors/past/conocophillips.png', '/static/img/sponsors/past/aramco.png', '/static/img/sponsors/past/shell.svg', '/static/img/sponsors/past/bp.png']
  }, {
    industryName: 'Consulting',
    industryId: 'industry-consulting',
    industryDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus id est nec molestie. Phasellus sit amet finibus enim. Sed aliquet mauris a velit ultricies, et ultricies velit malesuada.',
    industryImgPath: './static/img/icons/consulting.svg',
    industryPastSponsors: ['/static/img/sponsors/past/motiva.png', '/static/img/sponsors/past/cbre.png']
  }, {
    industryName: 'Finance',
    industryId: 'industry-finance',
    industryDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus id est nec molestie. Phasellus sit amet finibus enim. Sed aliquet mauris a velit ultricies, et ultricies velit malesuada.',
    industryImgPath: './static/img/icons/finance.svg',
    industryPastSponsors: ['/static/img/sponsors/past/goldmansachs.png', '/static/img/sponsors/past/usaa.png']
  }, {
    industryName: 'Transportation',
    industryId: 'industry-transportation',
    industryDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus id est nec molestie. Phasellus sit amet finibus enim. Sed aliquet mauris a velit ultricies, et ultricies velit malesuada.',
    industryImgPath: './static/img/icons/transportation.svg',
    industryPastSponsors: ['/static/img/sponsors/past/tti_logo.png']
  }, {
    industryName: 'Education',
    industryId: 'industry-education',
    industryDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus id est nec molestie. Phasellus sit amet finibus enim. Sed aliquet mauris a velit ultricies, et ultricies velit malesuada.',
    industryImgPath: './static/img/icons/education.svg',
    industryPastSponsors: ['/static/img/sponsors/past/csce.png', '/static/img/sponsors/past/science.png', '/static/img/sponsors/past/tamids_logo.png', '/static/img/sponsors/past/stat_logo.png', '/static/img/sponsors/past/math_logo.png']
  }, {
    industryName: 'Sports',
    industryId: 'industry-sports',
    industryDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus id est nec molestie. Phasellus sit amet finibus enim. Sed aliquet mauris a velit ultricies, et ultricies velit malesuada.',
    industryImgPath: './static/img/icons/sports.svg',
    industryPastSponsors: []
  }, {
