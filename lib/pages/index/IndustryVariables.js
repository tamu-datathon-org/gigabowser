...
const IndustryVariables = {
  industryModalVariables: [{
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-technology")),
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-energy")),
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-consulting")),
...
`,
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-finance")),
...
`,
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-transportation")),
...
`,
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-education")),
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-sports")),
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-healthcare")),
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-aerospace")),
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-insurance")),
    ...
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-retail")),
    industryImgPath: "./static/img/icons/retail.svg"
  }, {
    industryName: "Public Policy",
    industryId: "industry-publicpolicy",
    industryDescription: `
    <p>Investigate crime and law enforcement, the presidential election, or the census data!</p>
    <h6>Kaggle Competitions:</h6>
    <ul>
        <li><a href="https://www.kaggle.com/benhamner/2016-us-election" target="_blank">US Election Data</a></li>
        <li><a href="https://www.kaggle.com/fbi-us/california-crime" target="_blank">Crime Statistics</a></li>
        <li><a href="https://www.kaggle.com/c/us-census-challenge" target="_blank">US Census</a></li>
    </ul>
    `,
    industryPastSponsors: sponsors.pastSponsors.filter(item => item.industries.includes("industry-publicpolicy")),
    industryCurrentSponsors: sponsors.currentSponsors.filter(item => item.industries.includes("industry-publicpolicy")),
    industryImgPath: "./static/img/icons/publicpolicy.svg"
  }]
};
