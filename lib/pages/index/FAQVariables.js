...
// questions on the middle of the screen
const MHS = [{
  q: "When is the event?",
...
const RHS = [{
  ...
  a: "Registration will open on July 1st, 2020 and will close on October 1st, 2020. Admission decisions will be released shortly after the registration period closes.",
  idx: 7
}, {
  q: "How do teams work?",
  ...
  a: '</br></br>Send us an email at <a href="mailto:connect@tamudatathon.com">connect@tamudatathon.com</a>',
  idx: 9
}];
