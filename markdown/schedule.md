    ...
    <div class="d-flex flex-row">
      ...
      <div style="font-size: 1.5rem" class="ml-4">
        ...
        <div class="d-flex flex-row pb-3">
          ...
          <div class="named-text mx-3"><b>Opening Ceremony</a></b><br/><small class="text-muted d-block d-md-none">10:00 AM</small></div>
          <div class="mx-3"></div>
        </div>
        <div class="d-flex flex-row pb-3">
        ...
        <div class="d-flex flex-row pb-3">
          ...
          <div class="named-text mx-3"><b>Workshop #1</b></a><br/><small class="text-muted d-block d-md-none">1:00 PM</small></div>
          <div class="mx-3"></div>
        </div>
        <div class="d-flex flex-row pb-3">
          <div class="left px-3"><img src="/static/img/graphics/cube_green.svg" style="width:100%;"></img></div>
          <div class="mid px-3 d-none d-md-block">2:00 PM</div>
          <div class="named-text mx-3"><b>Workshop #2</b><br/><small class="text-muted d-block d-md-none">2:00 PM</small></a></div>
          <div class="mx-3"></div>
        </div>
        <div class="d-flex flex-row pb-3">
          <div class="left px-3"><img src="/static/img/graphics/cube_green.svg" style="width:100%;"></img></div>
          <div class="mid px-3 d-none d-md-block">3:00 PM</div>
          <div class="named-text mx-3"><b>Workshop #3</b></a><br/><small class="text-muted d-block d-md-none">3:00 PM</small></div>
          <div class="mx-3"></div>
        </div>
        <div class="d-flex flex-row pb-3">
          <div class="left px-3"><img src="/static/img/graphics/cube_green.svg" style="width:100%;"></img></div>
          <div class="mid px-3 d-none d-md-block">4:00 PM</div>
          <div class="named-text mx-3"><b>Workshop #4</b></a><br/><small class="text-muted d-block d-md-none">4:00 PM</small></div>
          <div class="mx-3"></div>
        </div>
        <div class="d-flex flex-row pb-3">
          ...
          <div class="named-text mx-3"><b>Smash Tournament</b></a><br/><small class="text-muted d-block d-md-none">5:00 PM</small></div>
          <div class="mx-3"></div>
        </div>
        <div class="d-flex flex-row pb-3">
          <div class="left px-3"><img src="/static/img/graphics/cube_yellow.svg" style="width:100%;"></img></div>
        ...
        <div class="d-flex flex-row pb-3">
          ...
          <div class="named-text mx-3"><b>Zumba Class</b><br/><small class="text-muted d-block d-md-none">9:00 PM</small></div>
          <div class="mx-3"></div>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex flex-row mt-n2">
      ...
      <div style="font-size: 1.5rem" class="ml-4">
        <div class="d-flex flex-row pt-3 pb-3">
          ...
          <div class="named-text mx-3"><b>Midnight Boba</b><br/><small class="text-muted d-block d-md-none">12:00 AM</small></div>
          <div class="mx-3"></div>
        </div>
        <div class="d-flex flex-row pb-3">
          <div class="left px-3"><img src="/static/img/graphics/cube_yellow.svg" style="width:100%;"></img></div>
        ...
        <div class="d-flex flex-row pb-3">
          <div class="left px-3"><img src="/static/img/graphics/cube_pink.svg" style="width:100%;"></img></div>
          <div class="mid px-3 d-none d-md-block">3:00 PM</div>
          <div class="named-text mx-3"><b>Closing Ceremony</b></a><br/><small class="text-muted d-block d-md-none">3:00 PM</small></div>
          <div class="mx-3"></div>
        </div>
      </div>
    </div>
